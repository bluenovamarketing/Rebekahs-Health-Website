...
<main id="main">
	...
	<section class="cta"><div><span class="eyebrow" style="color:#f1d4dc">Stay in the loop</span><h2>Be the first to hear what is happening near you.</h2></div><div><p>Choose your preferred store for classes, events, new arrivals and practical wellness education.</p><a class="pill honey" href="<?php echo esc_url( home_url( '/#connect' ) ); ?>">Stay Connected</a></div></section>
</main>
