...
<header id="site-header" class="site-header">
	...
	<nav id="nav" aria-label="Main navigation">
		...
		<div class="nav-dropdown"><button class="nav-trigger" type="button" aria-expanded="false">In-Store Products <span class="chevron" aria-hidden="true">&#9662;</span></button><div class="dropdown-panel"><a href="<?php echo esc_url( home_url( '/in-store-products/' ) ); ?>">Browse In-Store Products</a><a href="<?php echo esc_url( home_url( '/rebekahs-signature-line/' ) ); ?>">Rebekah&rsquo;s Signature Line</a></div></div><a href="<?php echo esc_url( home_url( '/shop-fullscript/' ) ); ?>">Shop Fullscript</a><a href="<?php echo esc_url( home_url( '/events/' ) ); ?>">Classes &amp; Events</a><a href="<?php echo esc_url( home_url( '/blog/' ) ); ?>">Wellness Source Blog</a>
