...
function rhn_phase_two_product_image_fallback( $label = '' ) {
	...
	<div class="rhn-product-image-fallback" role="img" aria-label="<?php echo esc_attr( $label ); ?>">
		<span class="rhn-product-image-fallback__mark" aria-hidden="true"><img src="<?php echo esc_url( rhn_theme_asset( 'img/rebekahs-site-icon-512.png' ) ); ?>" alt=""></span>
		<span class="rhn-product-image-fallback__kicker"><?php esc_html_e( 'Finishing touch', 'rebekahs-2026' ); ?></span>
		<strong class="rhn-product-image-fallback__label"><?php echo esc_html( $label ); ?></strong>
		<span class="rhn-product-image-fallback__view"><?php esc_html_e( 'Front image', 'rebekahs-2026' ); ?></span>
	</div>
	<?php
}
