...
// Load the client-approved Phase Two ecommerce chrome only on staging. The
// theme module remains dormant everywhere else unless this flag is explicitly
// supplied by another environment-specific configuration.
if ( ! defined( 'RHN_PHASE_TWO_ECOMMERCE_ENABLED' ) ) {
	define( 'RHN_PHASE_TWO_ECOMMERCE_ENABLED', true );
}
