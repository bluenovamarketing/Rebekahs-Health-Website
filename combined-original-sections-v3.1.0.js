(async()=>{
  ...
  function separateShippingPhotos(root){
    root?.querySelectorAll(".shipping-photo").forEach(photo=>{
      const image=photo.querySelector("img");
      if(!image||image.parentElement?.classList.contains("shipping-photo-frame"))return;
      const frame=document.createElement("span");
      frame.className="shipping-photo-frame";
  ...
  mounts.forEach(mount=>{
    ...
    if(name==="shipping"){
      ...
      separateShippingPhotos(section);
    }
    if(name==="events"){
