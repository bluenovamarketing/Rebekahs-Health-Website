...
$sourceDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.2.pptx'
$narratedDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.2-narrated.pptx'
$videoPath = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.2.mp4'
$masterAudio = Join-Path $packageRoot 'Practitioner-Editing-Narration-v1.2.wav'
...
try {
    ...
    $audioShape.Name = 'Continuous Narration v1.2'
