...
$sourceDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.3.pptx'
$narratedDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.3-narrated.pptx'
$videoPath = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.3.mp4'
$masterAudio = Join-Path $packageRoot 'Practitioner-Editing-Narration-v1.3.wav'
...
try {
    ...
    $audioShape.Name = 'Continuous Narration v1.3'
