...
$sourceDeck = Join-Path $packageRoot 'Add-New-Practitioner-or-Practice-v1.1.pptx'
$narratedDeck = Join-Path $packageRoot 'Add-New-Practitioner-or-Practice-v1.1-narrated.pptx'
$videoPath = Join-Path $packageRoot 'How-to-Add-a-New-Practitioner-or-Practice-v1.1.mp4'
$masterAudio = Join-Path $packageRoot 'Add-New-Practitioner-Narration-v1.1.wav'
