...
$sourceDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.4.pptx'
$narratedDeck = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.4-narrated.pptx'
$videoPath = Join-Path $packageRoot 'Practitioner-Editing-Video-v1.4.mp4'
$masterAudio = Join-Path $packageRoot 'Practitioner-Editing-Narration-v1.4.wav'
...
try {
    ...
    $audioShape.Name = 'Continuous Narration v1.4 - Microsoft Mark'
