...
if ($narrationMatches.Count -ne 13) {
    throw "Expected 13 narration scenes, but found $($narrationMatches.Count)."
}
...
Write-Output "Created $($manifest.Count) complete narrated event scene files using Microsoft Mark."
